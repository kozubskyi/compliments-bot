...
- upd "id" "field" "value" - оновити поле "field" компліментика з id "id" в базі даних новим значенням "value";
...
- delallcompliments - видалити всі компліментики з бази даних (не рекомендовано);
...
/sendingsreset - скинути поле sendings усіх компліментиків до 0;
